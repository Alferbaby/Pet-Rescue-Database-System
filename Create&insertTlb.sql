...
AID INTEGER,
FOREIGN KEY (AID) REFERENCES Adopter(ID) ON DELETE NO ACTION ON UPDATE
CASCADE
);
...
FOREIGN KEY (AID) REFERENCES Adopter(ID) ON DELETE CASCADE ON UPDATE
CASCADE
);
...
Description Char(200),
Vaccine_status boolean not null default 0,
...
FOREIGN KEY (ID) REFERENCES Adopter(ID) ON DELETE NO ACTION ON UPDATE
CASCADE
);
...
End_date DATE,
Description Char(100),
FOREIGN KEY (PID) REFERENCES Pet(ChipID) ON DELETE NO ACTION ON UPDATE
CASCADE
);
...
INSERT INTO Pet(ChipID, Name, Age,Description)
VALUES (1, 'Happy',3,'be alone' );
INSERT INTO Pet(ChipID, Name, Age, Description)
VALUES (2, 'Bebe', 4 ,'aggressive');
INSERT INTO Pet(ChipID, Name, Age, Description)
VALUES (3, 'Molly', 5,'smart' );
INSERT INTO Pet(ChipID, Name, Age, Description)
VALUES (4, 'Bob', 2,'friendly');
INSERT INTO Pet(ChipID, Name, Age, Description)
VALUES (5, 'Mac', 7 ,'aggressive');
INSERT INTO Pet(ChipID, Name, Age, Description)
VALUES (6, 'Apple', 3,'aggressive');
INSERT INTO Pet(ChipID, Name, Age, Description)
VALUES (7, 'Pie', 2 ,'aggressive');
...
VALUES ( '8888 University Dr', 'V5A1S6', '2020-01-11', 'No additional info');
INSERT INTO RescueEvent(Location,PostalCode, Date, Description)
VALUES ( '8888 University Dr', 'V5A1S6', '2020-01-12', 'No additional info');
INSERT INTO RescueEvent(Location,PostalCode, Date, Description)
VALUES ( '8888 University Dr', 'V5A1S6', '2020-01-13', 'No additional info');
INSERT INTO RescueEvent(Location,PostalCode, Date, Description)
VALUES ( '8888 University Dr', 'V5A1S6', '2020-01-14', 'No additional info');
INSERT INTO RescueEvent(Location,PostalCode, Date, Description)
VALUES ( '8888 University Dr', 'V5A1S6', '2020-01-15', 'No additional info');
INSERT INTO RescueEvent(Location,PostalCode, Date, Description)

VALUES ( '8888 University Dr', 'V5A1S6', '2020-01-18', 'No additional info');
INSERT INTO RescueEvent(Location,PostalCode, Date, Description)
VALUES ( '8888 University Dr', 'V5A1S6', '2020-01-19', 'No additional info');
INSERT INTO RescueEvent(Location,PostalCode, Date, Description)
VALUES ( '8888 University Dr', 'V5A1S6', '2020-01-20', 'No additional info');
...
INSERT INTO Vet (VID, Name, Specialization)
VALUES(6 ,'Windy' , 'Emergency Treatment');
